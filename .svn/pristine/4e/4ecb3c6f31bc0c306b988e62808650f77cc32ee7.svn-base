...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $logact->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Logacts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/logacts/'.$logact->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Logacts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.logacts.destroy', $logact->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/logacts') }}" data-toggle="tooltip" data-placement="right" title="Back to Logacts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'menuname')
						@la_display($module, 'act')
						@la_display($module, 'idpemda')
						@la_display($module, 'no_reg')
						@la_display($module, 'tgl_perolehan')
						@la_display($module, 'harga')
						@la_display($module, 'luas')
