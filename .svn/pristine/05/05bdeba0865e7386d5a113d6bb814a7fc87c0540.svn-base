...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $pengajuan_loaning->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Pengajuan_loanings", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/pengajuan_loanings/'.$pengajuan_loaning->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Pengajuan_loanings", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.pengajuan_loanings.destroy', $pengajuan_loaning->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/pengajuan_loanings') }}" data-toggle="tooltip" data-placement="right" title="Back to Pengajuan loanings"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'alasan_peminjaman')
						@la_display($module, 'peminjam')
						@la_display($module, 'tgl_peminjaman')
						@la_display($module, 'tgl_pengembalian')
						@la_display($module, 'no_polisi')
