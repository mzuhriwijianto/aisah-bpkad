...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-sm-3 actions rightPane">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/racks#lists') }}" data-toggle="tooltip" data-placement="right" title="Back to Racks"><i class="fa fa-chevron-left"></i></a></li>
				...
				<div class="panel infolist">
					<ul class="timeline timeline-inverse">
						...
						<div class="timeline-item">
							...
							<h3 class="timeline-header">Update By : <a href="#">{{ $kendaraans[0]->update_by }}</a></h3>
						</div>
						</li>
						<!-- END timeline item -->
						...
						<div class="timeline-item">
							<h3 class="timeline-header"><a href="#">Document</a></h3>
							<div class="timeline-body">
