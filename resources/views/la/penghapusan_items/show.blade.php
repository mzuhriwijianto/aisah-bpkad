...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $penghapusan_item->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Penghapusan_items", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/penghapusan_items/'.$penghapusan_item->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Penghapusan_items", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.penghapusan_items.destroy', $penghapusan_item->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/penghapusan_items') }}" data-toggle="tooltip" data-placement="right" title="Back to Penghapusan items"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'no_ajuan')
						@la_display($module, 'idpemda')
						@la_display($module, 'Validation')
						@la_display($module, 'validation_by')
						@la_display($module, 'validation_at')
						@la_display($module, 'kd_aset8')
						@la_display($module, 'kd_aset80')
						@la_display($module, 'kd_aset81')
						@la_display($module, 'kd_aset82')
						@la_display($module, 'kd_aset83')
						@la_display($module, 'kd_aset84')
						@la_display($module, 'kd_aset85')
					</div>
				</div>
			</div>
		</div>
