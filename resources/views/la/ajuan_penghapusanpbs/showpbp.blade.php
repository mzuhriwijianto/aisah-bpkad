					...
					<div class="panel-default panel-heading">
						<div class="box-body table-responsive">
							...
							<div class="col-md-3">								
								...
								<h4> Proses Pengurus Barang</h4>
									@if($ajuan_penghapusanpbp->validation_pb == 1 )					
										<form action = "/admin/ajuan_penghapusanpbs/ajukanpb2/{{ $ajuan_penghapusanpbp->id }}" method="get" enctype="multipart/form-data">
											<input name="_token" type="hidden" value="{{ csrf_token() }}">																					
											<button type="submit" name="submit" class="btn btn-success ">Validasi</button>										
										</form>
									@elseif($ajuan_penghapusanpbp->validation_pb == 2)
										<button type="submit" name="submit" class="btn btn-success " disabled>Validasi</button>										
									@endif
