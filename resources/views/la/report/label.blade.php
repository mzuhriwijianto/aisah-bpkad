...
<head>
    ...
    <title>LABEL</title>
	    ...
	    <style type="text/css">
@page { size: 10cm 10cm protrait; margin: 2px 2px 0px 0px;}
...
<table class="minimalistBlack" style="width: 100%;">
	<tbody>	
		...
		@php
			...
			$barcode = "http://aisah.bpkad.id/check_kibb/".$kibbitems->idpemda
		@endphp
		...
		<tbody>
			...
			<tr><td><b>Merk</td><td colspan = "4">:</b>{{ $kibbitems->merk }}</td></tr>																		
