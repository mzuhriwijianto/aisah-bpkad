						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center;">					
									...
									<img src="{{ public_path('storage/php_ppb/Image/'.$data_bs->imgname) }}" alt="gambar" width = "190" height = "160"/>									
									@else
									<i>no pic</i>
									@endif					
								</td>
							...
							<tr>
								...
								<td style="text-align:center;">					
									@if($data_cs->validation_img != '')
										<img src="{{ public_path('storage/php_ppb/Image/'.$data_cs->imgname) }}" alt="gambar" style="width:150px;height:120px;"/>							
									@else
									<i>no pic</i>
									@endif					
								</td>	
							...
							<tr>
								...
								<td style="text-align:center;">					
									@if($data_ds->validation_img != '')
										<img src="{{ public_path('storage/php_ppb/Image/'.$data_ds->imgname) }}" alt="gambar" />								
									@else
									<i>no pic</i>
									@endif					
								</td>			
							...
							<tr>
								...
								<td style="text-align:center;">				
										@if($data_es->validation_img != '')
											<img src="{{ public_path('storage/php_ppb/Image/'.$data_es->imgname) }}" alt="gambar" style="width:150px;height:120px;"/>							
										@else
										<i>no pic</i>
										@endif					
								</td>		
							...
							<tr>
								...
								<td style="text-align:center;">					
									@if($data_fs->validation_img != '')									
										<img src="{{ public_path('storage/php_ppb/Image/'.$data_fs->imgname) }}" alt="gambar" style="width:150px;height:120px;"/>						
									@else
									<i>no pic</i>
									@endif					
								</td>			
