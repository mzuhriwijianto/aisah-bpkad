...
<head>
	...
	<meta charset="UTF-8">
    <title>DATA GEDUNG & BANGUNAN</title>
...
<tbody>
	<tr>
			...
			<td style="width: 50%;text-align:center;">
				...
				<br/>
				<b style = "font-size: 14px;">DATA GEDUNG DAN BANGUNAN/KIBC</b>
			</td>
...
<table style="width: 100%;">
	<tbody>
		...
		<tr>
			<td><b>DATA GEDUNG & BANGUNAN</b></td>
		</tr>
	</tbody>
</table>
<table style="width: 100%;">
	<tbody>
		...
		<tr>
			<td style="width: 19%;">KOORDINATOR X</td>
			<td style="width: 1%;">:</td>
			<td style="width: 80%;">{{ $koordx }}</td>
		</tr>
		<tr>
			<td style="width: 19%;">KOORDINATOR Y</td>
			<td style="width: 1%;">:</td>
		...
		<tr>
			...
			<td style="width: 1%;">:</td>
			<td style="width: 80%;">{{ ($dokumen_nomor == 'NULL' OR $dokumen_nomor == '') ? '-' : $dokumen_nomor }}</td>
		</tr>
		<tr>
			<td style="width: 19%;">TANGGAL DOKUMEN</td>
			<td style="width: 1%;">:</td>
			<td style="width: 80%;">{{ ($dokumen_tanggal == 'NULL' OR $dokumen_tanggal == '') ? '-' : date('d-m-Y', strtotime($dokumen_tanggal)) }}</td>
		</tr>
		<tr>
...
<table>
	<tbody>
		<!--<tr>
			<td>DOKUMEN IMB</td>
			<td>:</td>
			<td>{{ (( $upload_dok_imb == '' OR $upload_dok_imb == '0') ? 'X' : 'V') }}</td>
		</tr>-->
		<tr>
			<td>PHOTO KIBC</td>
			<td>:</td>
			<td>{{ (( $photo_gedung == '' OR $photo_gedung == '0') ? 'X' : 'V') }}</td>
		</tr>
	</tbody>
</table>
<table style="width: 100%;">
