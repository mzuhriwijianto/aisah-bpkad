...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $persediaan_instock->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Persediaan_instocks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/persediaan_instocks/'.$persediaan_instock->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Persediaan_instocks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.persediaan_instocks.destroy', $persediaan_instock->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/persediaan_instocks') }}" data-toggle="tooltip" data-placement="right" title="Back to Persediaan instocks"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'ref_persediaan')
						@la_display($module, 'ref_brg')
						@la_display($module, 'kd_bidang')
						@la_display($module, 'kd_unit')
						@la_display($module, 'kd_sub')
						@la_display($module, 'kd_upb')
						@la_display($module, 'jml_instock')
						@la_display($module, 'tgl_instock')
						@la_display($module, 'tahun_instock')
					</div>
				</div>
			</div>
		</div>
